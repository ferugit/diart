...
def DER(
    ...
    mdEval = os.path.join(curr, "/home/azureuser/resources/util/DER_cal/md-eval-22.pl")
...
reference = "/home/azureuser/resources/util/DER_cal/sample_manual.rttm"
system = "/home/azureuser/resources/output/sample_step5.rttm"
score = DER(reference, system, True, 0.25, True)
print(score)
# print(f"Missed Speaker: {ms:.2f}%")
# print(f"False Alarm: {fa:.2f}%")
# print(f"Speaker Error Rate: {ser:.2f}%")
# print(f"Diarization Error Rate: {der:.2f}%")